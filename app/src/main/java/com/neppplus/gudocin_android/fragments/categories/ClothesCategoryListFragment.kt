...
import com.neppplus.gudocin_android.databinding.FragmentClothesCategoryListBinding
...
class ClothesCategoryListFragment : BaseFragment() {
    ...
    lateinit var binding: FragmentClothesCategoryListBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.fragment_clothes_category_list,
                container,
                false
            )
        return binding.root
